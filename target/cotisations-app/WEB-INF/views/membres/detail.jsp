...
<div class="d-flex align-items-center gap-3 mb-4">
    ...
    <h2 style="font-size:20px;font-weight:700;color:var(--primary)">Fiche Membre</h2>
</div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div style="text-align:center;margin-bottom:20px">
                <div style="width:72px;height:72px;background:linear-gradient(135deg,var(--primary),#3f51b5);border-radius:50%;display:flex;align-items:center;justify-content:center;color:white;font-size:28px;font-weight:700;margin:0 auto 12px">
                    ${membre.prenom.charAt(0)}
                </div>
                <h3 style="font-size:18px;font-weight:700">${membre.nomComplet}</h3>
                <c:choose>
